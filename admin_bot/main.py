...
from services.default_prompts import DEFAULT_TRIGGER_AI_PROMPT, DEFAULT_TRIGGER_FOLLOWUP_PROMPT
...
async def main_bot_polling_task():
	...
	default_configs = {
		...
		"trigger_semantic_enabled": "False",
		"trigger_semantic_threshold": "0.72",
		"trigger_semantic_model": DEFAULT_OPENAI_MODEL,
		"trigger_semantic_max_tokens": "180",
		"trigger_semantic_max_per_minute": "30",
		"trigger_min_message_length": "3",
		"trigger_chat_cooldown_seconds": "120",
		"trigger_user_cooldown_seconds": "300",
		"trigger_intent_cooldown_seconds": "120",
		"listen_all": "True",
	...
	default_configs["ai_trigger_followup_prompt"] = DEFAULT_TRIGGER_FOLLOWUP_PROMPT
